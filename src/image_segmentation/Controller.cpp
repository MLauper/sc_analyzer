...
image_segmentation::Controller::Controller(int imageWidth, int imageHeight)
{
...
void image_segmentation::Controller::ProcessImage(SYSTEMTIME* time, af::array& image, std::string filename)
{
	...
	this->current_image_hsv = af::colorSpace(this->current_image, AF_HSV, AF_RGB);
